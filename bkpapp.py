...
UPLOAD_FOLDERPT = 'static/patio'
app.config['UPLOAD_FOLDER'] = UPLOAD_FOLDER
app.config['UPLOAD_FOLDERPT'] = UPLOAD_FOLDERPT
    ...
    if request.method == 'POST':
        ...
        def save_image(setor_auditado, upload_file):
            if upload_file and allowed_file(upload_file.filename):
                ...
                upload_file.save(os.path.join(app.config['UPLOAD_FOLDERPT'], filename))
                return filename
            return None
